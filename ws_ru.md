...
|--------------| -----------------| ---------- |----------| ------------| --------------------------------------------------------------------------------|
|символ | правда | строка | символ контракта |               |напр. "BTC_CW" означает BTC “this_week”、"BTC_NW" означает BTC “next_week”、"BTC_CQ" означает BTC “quarter“|
|период | правда | строка | период Kline |             |1мин, 5мин, 15мин, 30мин, 60мин, 1день, 1мес, 1неделя, 1год|
